...
- 背包系统：查看、使用、丢弃物品
- 背包容量：默认 20 格，背包满时无法购买或拾取战斗掉落
- 商店系统：购买/出售经验卡、强化卷、回血药、回蓝药、狂暴药水、虚弱药水、疲惫药水
- 城镇服务：仓库、银行、铁匠铺，仅城镇节点可使用
- 战斗系统：回合制战斗、敌人特殊行为、战斗药水、战斗掉落、死亡掉落惩罚
- 任务系统：接受任务、更新进度、领取奖励
- 地图系统：校园节点移动、随机遇敌、出城探险、每 3 次战斗发现休息点可回城
- 存档系统：最多 4 个独立存档槽，可新建、读取、保存、删除
- 等级框架：角色等级上限 30 级，城镇区域按等级段划分
- 主线/编队框架：保留前排 1 人、后排 2 人和主线关卡推进的扩展入口
